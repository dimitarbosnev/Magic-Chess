...
namespace server
{
    ...
    class LobbyRoom : SimpleRoom
    {
        ...
        protected override void addMember(TcpMessageChannel pMember)
        {
            ...
            simpleMessage.message = "Client '" + _server.GetPlayerInfo(pMember).playerName + "' has joined the lobby!";
        ...
        public void sendGameResult(List<TcpMessageChannel> pMembers, PlayerInfo winner)
        {
            foreach (TcpMessageChannel member in pMembers)
            {
            ...
            {
                ChatMessage simpleMessage = new ChatMessage();
                simpleMessage.message = "'" + _server.GetPlayerInfo(member).playerName + "' has returned from a game!";
