...
namespace server
{
    ...
    class TCPGameServer
    {
        ...
        private List<GameRoom> _gameRooms = new List<GameRoom>();      //this is the room a user moves to when a game is succesfully started
        private List<GameRoom> _gamesToClose = new List<GameRoom>();
        ...
        public void StartNewGame(TcpMessageChannel pPlayer1, TcpMessageChannel pPlayer2)
        {
            GameRoom newGame = new GameRoom(this);
            newGame.StartGame(pPlayer1, pPlayer2);
            _gameRooms.Add(newGame);
        }

        public void CloseGameRoom(GameRoom gameRoom) { _gamesToClose.Add(gameRoom); }
        ...
        //public GameRoom GetGameRoom() { return _gameRooms; }
