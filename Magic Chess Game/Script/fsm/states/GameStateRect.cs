 ...
 */
public class GameStateRect : ApplicationStateWithView<GameViewRect>
{
    ...
    private void sendMakeMoveRequest(PieceReleaseEvent releaseEvent){
        ...
        //TODO: dont forget to change it with actual chessboarddata
        RectChessBoardData boardData = new RectChessBoardData();
        boardData.CopyBoard(ChessBoard.Instance.GetBoardData());
        MakeMoveRequest makeMove = new MakeMoveRequest(releaseEvent.command, boardData);
